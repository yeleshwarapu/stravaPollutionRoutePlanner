...
-----
  ...
  # Custom origin
  python main.py --lat 33.9737 --lon -117.3281
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--lat",        type=float, default=33.9648, help="Origin latitude")
    p.add_argument("--lon",        type=float, default=-117.3408, help="Origin longitude")
